...
export const MOCK_HIGHLIGHTS: NetworkUser[] = [
  ...
  { id: 4, name: "Júlio Reis", role: "Desenvolvedor(a) backend", avatarUrl: avatar4 },
...
export const MOCK_SUGGESTIONS: Page<NetworkUser> = {
  content: [
    ...
    { id: 103, name: "Júlio Reis", role: "Desenvolvedor(a) frontend", company: "Meta", location: "Imperatriz, MA", avatarUrl: avatarSuggestion },
    { id: 104, name: "Júlio Reis", role: "Desenvolvedor(a) frontend", company: "Meta", location: "Imperatriz, MA", avatarUrl: avatarSuggestion },
    { id: 105, name: "Júlio Reis", role: "Desenvolvedor(a) backend", company: "Google", location: "Imperatriz, MA", avatarUrl: avatarSuggestion },
